...
const Pagi: React.FC<{totalPage: number, page: number, onChange: (page: number) => void, totalItem: number}> = ({totalPage, page, onChange, totalItem}) => {
    return (
        <div className='grid grid-cols-4 items-center'>
            <span className='text-base-drak-gray text-sm'>Tổng hiển thị: {totalItem}</span>
