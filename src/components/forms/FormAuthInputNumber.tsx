...
const FormAuthInputNumber: React.FC<TProps> = ({
  onChange: onChange1,
  onBlur: onBlur1,
  name,
  rules,
            ...
            <div className="w-full">
              <input
                ...
                className={clsx(
                  ...
                  `w-full h-[40px] text-base border-t-0 !border-x-0 !bg-transparent 
                  hover:border-x-none !shadow-none hover:!border-golden
                  text-text-blur !border-b border-gray rounded-none !bg-none focus-within:border-golden`,
                )}
              />
              <ErrorMessage
                errors={errors}
...
export default FormAuthInputNumber
