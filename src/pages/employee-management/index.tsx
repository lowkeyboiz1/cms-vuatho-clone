  ...
  return (
    <div className="pb-5">
      <h5
        ...
        className="text-xl 13inch:text-2xl font-bold"
      >
        Tổng quan phòng ban
      </h5>
      <div className="grid grid-cols-4 gap-5">
        <div
          className={`p-4 13inch:p-6 bg-white rounded-2xl flex flex-col gap-6 min-h-[280px] shadow-[4px_4px_16px_0_rgba(0,18,38,0.08)]`}
        >
          <div className="space-y-1 13inch:space-y-2">
            <h6 className="text-sm 13inch:text-base">Tổng số lượng</h6>
            <h6 className="text-lg 13inch:text-xl font-bold">7 Phòng ban</h6>
          </div>
        ...
        {dataDepartment.map(item => (
          <div
            key={item.title}
            className="bg-white rounded-2xl p-4 13inch:p-6 space-y-3 13inch:space-y-6 min-h-[280px] shadow-[4px_4px_16px_0_rgba(0,18,38,0.08)]"
          >
            <h6 className="text-lg 13inch:text-xl font-bold">{item.title}</h6>
            <p className="text-sm 13inch:text-base">{item.desc}</p>
          </div>
        ))}
      </div>
    </div>
